struct RectInt2
{
    ...
    public readonly int RightIn  => BottomRight.X - 1;
    public readonly int Bottom   => BottomRight.Y;
    public readonly int BottomIn => BottomRight.Y - 1;

    public Int2 BottomRightIn
    {
        readonly get => BottomRight - Int2.One;
    ...
    public readonly bool HasCoord(Int2 coord) =>
        coord >= TopLeft == true && coord < BottomRight == true;
}
...
static partial class Extensions
{
    ...
    public static IEnumerable<Int2> Coords(this Int2 @this) =>
        RectInt2.FromSize(@this).Coords();

    public static IEnumerable<Int2> Coords(this RectInt2 @this)
    {
    ...
    public static IEnumerable<Int2> BorderCoords(this Int2 @this, Int2 border) =>
        RectInt2.FromSize(@this).BorderCoords(border);
    public static IEnumerable<Int2> BorderCoords(this Int2 @this, int border) =>
        RectInt2.FromSize(@this).BorderCoords(new Int2(border));
    public static IEnumerable<Int2> BorderCoords(this Int2 @this) =>
        @this.BorderCoords(Int2.One);

    public static IEnumerable<Int2> BorderCoords(this RectInt2 @this, Int2 border)
    {
    ...
    public static IEnumerable<Int2> BorderCoords(this RectInt2 @this, int border) =>
        @this.BorderCoords(new Int2(border));
    public static IEnumerable<Int2> BorderCoords(this RectInt2 @this) =>
        @this.BorderCoords(Int2.One);
    ...
    public static RectInt2 CalcBoundingBox(this IEnumerable<RectInt2> @this)
    {
